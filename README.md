# Copied from https://github.com/golang-standards/project-layout
...
* [Go Report Card](https://goreportcard.com/) - It will scan your code with `gofmt`, `go vet`, `gocyclo`, `golint`, `ineffassign`, `license` and `misspell`. Replace `github.com/<your-account>/<reporsitory>` with your project reference.
